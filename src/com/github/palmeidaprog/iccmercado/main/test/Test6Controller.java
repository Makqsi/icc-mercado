...
public class Test6Controller {
    ...
    private static volatile Test6Controller instance = null;
    private Test6Controller() { }
    public synchronized static Test6Controller getInstance() {
        if (instance == null) {
            instance = new Test6Controller();
        }
        return instance;
    }
    ...
    public void getYoutube() {
        openLink(Pesquisa.getInstance().getYoutube());
    }

    public void getWiki() {
        openLink(Pesquisa.getInstance().getWiki());
    }

    public void getGoogle() {
        openLink(Pesquisa.getInstance().getSearch());
    }
    ...
    public void setStars(int s) {
        stars = s;
        Pesquisa.getInstance().setStars(s);
    }
