...
public class Test5Controller {
    ...
    private static volatile Test5Controller instance = null;
    private Test5Controller() { }
    public synchronized static Test5Controller getInstance() {
        if (instance == null) {
            instance = new Test5Controller();
        }
        return instance;
    }
