...
public class Test1Controller {
    ...
    private static volatile Test1Controller instance = null;
    private Test1Controller() { }
    public synchronized static Test1Controller getInstance() {
        if (instance == null) {
            instance = new Test1Controller();
        }
        return instance;
    }
