...
public class ProfessorController {
    ...
    //--Singleton pattern--------------------------------------------------
    private static volatile ProfessorController instance = null;
    ...
    public void getYoutube() {
        openLink(Professor.getInstance().getYoutube());
    }

    public void getWiki() {
        openLink(Professor.getInstance().getWiki());
    }

    public void getGoogle() {
        openLink(Professor.getInstance().getSearch());
    }
