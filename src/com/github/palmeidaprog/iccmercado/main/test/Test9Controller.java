...
public class Test9Controller {
    ...
    private static volatile Test9Controller instance = null;
    private Test9Controller() { }
    public synchronized static Test9Controller getInstance() {
        if (instance == null) {
            instance = new Test9Controller();
        }
        return instance;
    }
    ...
    public void getYoutube() {
        openLink(Logica.getInstance().getYoutube());
    }

    public void getWiki() {
        openLink(Logica.getInstance().getWiki());
    }

    public void getGoogle() {
        openLink(Logica.getInstance().getSearch());
    }
