...
public class Test7Controller {
    ...
    private static volatile Test7Controller instance = null;
    private Test7Controller() { }
    public synchronized static Test7Controller getInstance() {
        if (instance == null) {
            instance = new Test7Controller();
        }
        return instance;
    }
    ...
    public void getYoutube() {
        openLink(Matematica.getInstance().getYoutube());
    }

    public void getWiki() {
        openLink(Matematica.getInstance().getWiki());
    }

    public void getGoogle() {
        openLink(Matematica.getInstance().getSearch());
    }
    ...
    public void setStars(int s) {
        stars = s;
        Matematica.getInstance().setStars(s);
    }
